      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 z-20">
          <div style={{ transform: "translateZ(80px)", transformStyle: "preserve-3d" }} className="flex flex-col items-center">
            ...
            />
            <h2 className="text-[clamp(4.5rem,10vw,5.5rem)] md:text-[clamp(7.5rem,16.5vw,21rem)] font-display font-black text-[#f8f9fa] leading-none tracking-tighter drop-shadow-[0_20px_50px_rgba(0,0,0,1)] group-hover:text-primary transition-all duration-700">
              {cat.title}
            </h2>
            <motion.p 
