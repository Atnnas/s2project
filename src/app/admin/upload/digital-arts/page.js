...
export default function DigitalArtsUploadPage() {
  return (
    <>
      <Navbar />
      <main className="flex-1 max-w-2xl mx-auto px-6 py-32 min-h-screen w-full">
        ...
        >
          <header className="mb-10 text-center">
            ...
            <h1 className="text-4xl font-display font-bold text-slate-900 dark:text-slate-100 mb-2">Nuevo Arte Digital</h1>
            <p className="text-slate-500 font-body">Subida de piezas gráficas y artes de alta fidelidad.</p>
          </header>

          <ProjectForm mode="art" defaultCategory="Arte Digital" />
        </motion.div>
      </main>
      <Footer />
    </>
