...
export default function ServiciosPage() {
  return (
    <>
      <Navbar />
      <main className="flex-1 max-w-6xl mx-auto px-6 py-32 min-h-screen">
        <h1 className="text-5xl font-display font-bold text-slate-900 dark:text-slate-100 mb-6">Nuestros Servicios</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 bg-white dark:bg-primary/5 rounded-2xl border border-primary/10 shadow-sm">
