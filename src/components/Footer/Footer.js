export default function Footer() {
  return (
    <footer data-navbar-theme="dark" className="bg-primary text-white py-20 px-6 mt-auto">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div className="space-y-6 pt-8">
          ...
          <div className="flex justify-center items-center gap-6">
            <a href="https://www.facebook.com/profile.php?id=61584523825008" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-all hover:scale-110 active:scale-95 border border-white/10">
            ...
            <a href="https://www.instagram.com/s2project_marketing/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-all hover:scale-110 active:scale-95 border border-white/10">
              <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
