  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-primary/10 dark:border-white/5 p-6 rounded-3xl shadow-2xl">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-black uppercase tracking-widest text-slate-900 dark:text-slate-100 mb-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-200 dark:hover:bg-white/10 transition-all"
                  >
                    Rechazar
                  </button>
                </div>
