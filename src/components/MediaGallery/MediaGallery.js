          ...
          {projects.map((project) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-[#9eb5b2]/20 group-hover:bg-[#9eb5b2]/40 transition-all flex items-center justify-center">
                ...
                {project.gallery?.length > 1 && (
                  <div className="absolute top-4 left-4 px-2 py-1 bg-[#9eb5b2]/40 backdrop-blur-md rounded-lg border border-white/10 text-[10px] text-white font-bold">
      ...
      <AnimatePresence mode="wait">
        {selectedProject && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] bg-[#9eb5b2]/95 backdrop-blur-xl flex items-center justify-center p-4 md:p-10"
