...
function MediaModal({ project, onClose }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#9eb5b2]/95 backdrop-blur-xl" onClick={onClose} />
      ...
      <motion.div
        ...
        className="relative z-[205] w-full max-w-6xl h-full flex flex-col md:flex-row bg-[#9eb5b2] rounded-[40px] overflow-hidden border border-white/10 shadow-2xl"
      >
        {/* Media Side */}
        <div className="flex-[1.5] bg-[#9eb5b2] relative flex items-center justify-center group/media overflow-hidden">
          {project.videoUrl ? (
            <iframe
