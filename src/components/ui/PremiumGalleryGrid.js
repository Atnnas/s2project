            ...
            >
              <div className="relative h-full w-full overflow-hidden rounded-[30px] md:rounded-[50px] shadow-2xl transition-all duration-700 group-hover:shadow-primary/30 group-hover:-translate-y-2">
                <div className={`relative w-full h-full ${isHero ? 'aspect-square md:aspect-auto md:h-full' : 'aspect-[4/5]'}`}>
                  ...
                  <div className="absolute inset-0 bg-[#1d2729]/80 group-hover:opacity-90 transition-opacity duration-500" />
...
function GalleryModal({ project, onClose }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#1d2729]/95 backdrop-blur-3xl" onClick={onClose} />
      ...
      <motion.div
        ...
        className="relative z-[305] w-full max-w-7xl h-full max-h-[90vh] bg-[#1d2729] rounded-[40px] md:rounded-[80px] overflow-hidden border border-white/5 shadow-[0_0_100px_rgba(0,0,0,1)] flex flex-col md:flex-row"
      >
        ...
        <div className="flex-1 p-8 md:p-20 flex flex-col justify-center bg-[#1d2729] border-l border-white/5 overflow-y-auto">
           <div className="space-y-10">
              ...
              <div className="pt-4">
                <button className="group/btn relative w-full bg-white text-black px-12 py-6 rounded-full font-display font-black uppercase tracking-[0.2em] text-xs hover:bg-primary hover:text-white transition-all duration-500 shadow-2xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-[#1d2729] translate-y-full group-hover/btn:translate-y-0 transition-transform duration-500" />
                </button>
              </div>
           </div>
        </div>
